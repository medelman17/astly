export default `<style role="styles">
  $color: red;
  .red {
  ...
  <div>
      ...
      <div>
      <h2 color="orange">Buttons are fun</h2>
      <button class="red"><span color="white">Primary Button<span></button>
      <button variant="primary"><span>Secondary Button<span></button>
